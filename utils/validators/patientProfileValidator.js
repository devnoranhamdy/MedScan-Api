...
exports.validateSpecificPatientProfile = [checkPatientId(), validationMiddleWare];
...
exports.ValidateCreatePatientProfile = [
    ...
    check("weight.unit")
      .optional()
      .equals("kg").withMessage("Weight unit must be kg."),
    ...
    check("height.unit")
      .optional()
      .equals("cm").withMessage("Height unit must be cm."),
    ...
    check("diseases")
      .optional()
      .isArray().withMessage("Diseases must be an array."),
  
    check("takesMedications")
      .optional()
      .isBoolean().withMessage("Takes medications must be true or false."),
    ...
    check("bodyTemperature")
      ...
      ,checkPatientId(),validationMiddleWare
  ];
